...
export default function TrustSection() {
    return (
        <section id="trust" className="section-padding gradient-pharma text-white relative overflow-hidden">
            ...
            <ScrollParallax speed={-0.1} className="absolute inset-0 pointer-events-none" aria-hidden="true">
                <div className="absolute top-0 left-0 w-full h-[150%] bg-[url('data:image/svg+xml;base64,')] opacity-50" />
            </ScrollParallax>

            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <ScrollParallax speed={0.05} className="text-center mb-14">
